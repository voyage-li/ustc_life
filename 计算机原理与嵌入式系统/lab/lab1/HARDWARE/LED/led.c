...
{    	 
  ...
  GPIO_Init(GPIOG, &GPIO_InitStructure);
	GPIO_ResetBits(GPIOG,GPIO_Pin_11 | GPIO_Pin_10 | GPIO_Pin_9 | GPIO_Pin_3 | GPIO_Pin_2 );//LED0,LED1,LED2,LED4,LED5
  ...
  GPIO_Init(GPIOD, &GPIO_InitStructure);
	GPIO_ResetBits(GPIOD, GPIO_Pin_7 |GPIO_Pin_13|GPIO_Pin_12);  //LED3 LED6,LED7		 
}
