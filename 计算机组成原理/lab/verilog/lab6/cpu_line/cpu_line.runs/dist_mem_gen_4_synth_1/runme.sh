...
HD_PWD='D:/za/cod/lab6/cpu_line/cpu_line.runs/dist_mem_gen_4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log dist_mem_gen_4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source dist_mem_gen_4.tcl
