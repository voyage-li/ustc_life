...
// sub, and, or ,xor, sll, srl, slt
// andi, ori, xori, slli, srli, slti
// bne, bge
...
module cpu_pipline(
    ...
    wire [31:0] memory_read_data_IF, memory_read_data_ID, memory_read_data_EX, memory_read_data_MEM, memory_read_data_WB;
    ...
    wire auipc_mux_ID, auipc_mux_EX;
    ...
    dist_mem_gen_4 Instruction_memory (
        .clk(clk),
        .we(1'b0),
        .d(0),
        .a(pc_IF[9:2]),
    ...
    assign jump = (jump_branch && Read_data_1_ID==Read_data_2_ID && ins_ID[14:12]==3'b000)||(jump_branch && Read_data_1_ID >= Read_data_2_ID && ins_ID[14:12]==3'b101)||(jump_branch && Read_data_1_ID!=Read_data_2_ID && ins_ID[14:12]==3'b001)||(jump_branch && Read_data_1_ID<Read_data_2_ID && ins_ID[14:12]==3'b100)||jal_ID;
    ...
    mux2to1 jalr_mux(
        .a(next_pc_pre),
        .b(Read_data_1_ID + immediate_num_ID),
        .sel(jalr && jump_branch),
        .out(next_pc)
    );
